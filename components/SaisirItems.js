  ...
  listItemRender(rowData) {
    ...
    return (
      <View style={styleContainer}>
        ...
        <View style={styles.itemInfo}>
          <Text style={styles.valeur}>{'Valor: ' + rowData.value}</Text>
        </View>
      </View>
    );
  }
    ...
    const listView = (
      <View>
        ...
        <Button
          ...
          onPress={() =>
            navigate('Sac', {
              sac: {poidsMax: this.state.sac.poidsMax, Items: this.state.Items},
            })
          }></Button>
      </View>
    );

    const text = <Text> Adicione Objetos para colocar na mochila. </Text>;
        ...
        <Modal isVisible={this.state.isModalVisible}>
          <View style={styles.modalContent}>
            ...
            <TextInput
              ...
              onChangeText={text =>
                this._updateName(text, this.state.CurrentIndex)
              }
              maxLength={40}
            ...
            <TextInput
              ...
              onChangeText={valeur =>
                this._updateValue(valeur, this.state.CurrentIndex)
              }
              underlineColorAndroid="#f2545B"
            />
            <TextInput
              ...
              onChangeText={poids =>
                this._updateWeight(poids, this.state.CurrentIndex)
              }
              underlineColorAndroid="#f2545B"
            />
